...
import TestPage from '~/features/exam/TestPage';
...
import Service from '~/features/policy/service';
import About from '~/features/intro';
import PostsPage from '~/features/posts/PostsPage';
import PostDetailPage from '~/features/posts/PostDetailPage';
import RecoveryResourceViewPage from '~/features/resources/RecoveryResourceViewPage';
import MyAlbumsPage from '~/features/album-voca/MyAlbumPage';
import AlbumDetailPage from '~/features/album-delta/AlbumDeltaPage';
import PracticePage from '~/features/album-pratice/PracticePage';
