...
export const congratsSeenKey = (learningPlanId: string): string => `plan-congrats-seen-${learningPlanId}`;
...
function PlanCongratsModal({ show, onClose, onNext, totalTasks, planSequence }: PlanCongratsModalProps) {
  if (!show) return null;
