...
public class EmailVerificationService {
    ...
    @Transactional
    public AuthMessageResponse verifyToken(String token) {
        ...
        if (user == null) {
            ...
            throw new BadRequestException("Không tìm thấy tài khoản liên kết với token này.");
        }
        ...
        if (ev.getExpiresAt().isBefore(Instant.now())) {
            ...
            throw new BadRequestException(
                    "Liên kết xác thực đã hết hạn. Tài khoản đã bị hủy, vui lòng đăng ký lại.");
        }
