...
//    public ResponseEntity<?> createPayment(HttpServletRequest req, @PathVariable String userId) throws UnsupportedEncodingException {
...
//            String userId = Long.parseLong(userIdStr);
